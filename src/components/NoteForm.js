    ...
    return (
        <div className="w-full flex flex-col items-center p-5 lg:p-10 bg-black/10 rounded-2xl mt-32 mx-5 md:mx-10">
            <div className="w-full flex flex-col items-center">
                ...
                <input id="note_name" type="text" name="name" className="w-72 md:w-2/3 h-10 rounded-full mt-1 bg-gray-300
            ...
            <div className="w-full flex flex-col items-center mt-3">
                ...
                <textarea id="note_text" name="message"  className="w-72 md:w-2/3 h-48 rounded-2xl mt-1 bg-gray-300
